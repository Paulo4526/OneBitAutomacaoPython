...
message.set_content(body, subtype='html') #Informando que o corpo do email é um html
safe = ssl.create_default_context()

#2 - Adicionando Anexo
anexo = 'files/texto-email.txt'
